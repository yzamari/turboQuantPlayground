...
@Composable
fun App() {
    // Backends are filtered by the .so's runtime probe — only ones that
    // actually init() show up here.
    ...
    var output by remember { mutableStateOf("Press Run to benchmark.") }
